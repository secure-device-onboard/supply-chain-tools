...
class VouchersControllerTest {
  ...
  void testGet() throws Exception {
    ...
    Voucher voucher = new Voucher(
      oh.toString(),
      new HashCodec().encode(new Hash.Null()),
      new CertPathCodec().encode(
        CertificateFactory
          .getInstance("X.509", BouncyCastleSingleton.INSTANCE)
    ...
    vEntry.setCustomer(new Customer(0, customerId, toX509(kp.getPublic())));
